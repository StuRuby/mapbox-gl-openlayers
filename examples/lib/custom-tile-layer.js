var CustomTileLayer = (function (mapboxGl, ol) {
    'use strict';
        ...
        createOlMap(type) {
            ...
            switch (type) {
                case 'WMTS':
                    ...
                    source = new ol.source.WMTS(Object.assign(this.tileOptions, {
                        tileGrid
                    }));
                    break;
                case 'XYZ':
                    tileGrid = new ol.tilegrid.WMTS(this.tileOptions.tileGrid);
                    source = new ol.source.XYZ(Object.assign(this.tileOptions, {
                        tileGrid
                    }));
                    break;
                default:
        ...
        createCustomWMTSLayer() {
            ...
            const customWMTSLayer = {
                ...
                render: function (gl, matrix) {
                    ...
                    const bl = mapboxGl.MercatorCoordinate.fromLngLat([extent[0], extent[1]]);
                    const tr = mapboxGl.MercatorCoordinate.fromLngLat([extent[2], extent[3]]);
                    data[0] = bl.x;
                    data[1] = tr.y;
                    data[2] = 0;
                    data[3] = 1;
